...
import { cronToHuman, formatDate } from "@/lib/utils"
import {
  CalendarClock,
  Plus,
  Pencil,
...
function buildCron(preset: string, hour: string, minute: string): string {
  ...
  if (!p) return ""
  // Replace hour/minute in the preset cron
      ...
      <div className="p-4 md:p-6 space-y-4">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-slate-500">
              Configure validacoes automaticas recorrentes
            </p>
          </div>
          <button
          ...
          <div className="grid gap-4">
            {schedules.map((schedule) => (
              ...
              >
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex flex-wrap items-center gap-x-4 gap-y-1 mt-2 text-xs text-slate-400">
                        {schedule.last_run && (
                          <span>Ultima execucao: {formatDate(schedule.last_run)}</span>
                        )}
                        {schedule.next_run && (
                          <span>Proxima execucao: {formatDate(schedule.next_run)}</span>
                        )}
                    ...
                    <div className="flex items-center gap-1 flex-shrink-0">
                      ...
                      <button
                        ...
                        className="p-2 rounded-lg text-slate-500 hover:bg-blue-50 hover:text-blue-600 dark:hover:bg-blue-950 dark:hover:text-blue-400 transition-colors"
                      ...
                      <button
                        ...
                        className="p-2 rounded-lg text-slate-500 hover:bg-red-50 hover:text-red-600 dark:hover:bg-red-950 dark:hover:text-red-400 transition-colors"
                        title="Excluir"
                      >
                ...
                {/* History section */}
                {expandedHistory === schedule.id && (
                  <div className="border-t border-slate-100 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 px-4 py-3">
                    ...
                    {historyLoading === schedule.id ? (
                      ...
                      <div className="space-y-2">
                        {historyData[schedule.id].map((entry) => (
                          <div
                            key={entry.id}
                            className="flex items-center justify-between bg-white dark:bg-slate-900 rounded-lg px-3 py-2 text-xs"
                          >
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="px-3 py-1.5 rounded-lg text-xs font-medium text-slate-600 bg-white border border-slate-200 hover:bg-slate-50 dark:bg-slate-800 dark:border-slate-700 dark:text-slate-300 transition-colors"
                        >
                          Cancelar
                        </button>
                        <button
        ...
        {showForm && (
          <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            />
            <div className="relative bg-white dark:bg-slate-900 rounded-xl shadow-xl border border-slate-200 dark:border-slate-800 w-full max-w-md mx-4">
              ...
              <form onSubmit={handleSubmit} className="p-5 space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-sm text-slate-900 dark:text-white placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-sm text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                  >
                ...
                {formPreset === "custom" && (
                  <div>
                    ...
                    <input
                      ...
                      placeholder="0 8 * * 1-5"
                      className="w-full px-3 py-2 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-sm text-slate-900 dark:text-white placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 font-mono"
                    />
                ...
                <div className="flex items-center gap-3 pt-2">
                  <button
                    ...
                    className="flex-1 px-4 py-2 rounded-lg text-sm font-medium text-slate-700 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:text-slate-300 dark:hover:bg-slate-700 transition-colors"
                  >
                    Cancelar
                  </button>
                  <button
